...
import com.winda.couchpotato.viewmodel.ShowsViewModel
import com.winda.couchpotato.viewmodel.ViewModelFactory
...
class CatalogueFragment : Fragment() {
    ...
    private fun observeLoadingStatus(){
        showsViewModel.getLoadingStatus().observe(viewLifecycleOwner, {
    ...
    private fun observeResponseCode(){
        showsViewModel.getResponseCode().observe(viewLifecycleOwner, {
