...
public class JsonHelper {
	...
	public void loadMovies(LoadItemsCallback callback) {
		String url = "https://api.themoviedb.org/3/discover/movie?api_key=d41df99ac455e611fbf59daae71c5bf3"  + "&language=en-US";
	...
	public void loadTvShows(LoadItemsCallback callback) {
		String url = "https://api.themoviedb.org/3/discover/tv?api_key=d41df99ac455e611fbf59daae71c5bf3" + "&language=en-US";
		new AsyncHttpClient().get(url, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
