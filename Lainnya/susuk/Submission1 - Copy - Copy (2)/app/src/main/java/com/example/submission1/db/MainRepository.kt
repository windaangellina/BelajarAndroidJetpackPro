...
open class MainRepository private constructor(val apiDataSource: ApiDataSource) : MainDataSource {

    companion object {
        @Volatile
        private var instance: MainRepository? = null

        fun getInstance(remoteData: ApiDataSource): MainRepository =
            instance ?: synchronized(this) {
                instance ?: MainRepository(remoteData).apply { instance = this }
            }
    }
