...
class MovieAdapters(private val callback: MovieCallback) :
    PagedListAdapter<MovieEntity, MovieAdapters.ListViewHolder>(DIFF_CALLBACK) {
    ...
    inner class ListViewHolder(private val binding: ItemDesignBinding) : RecyclerView.ViewHolder(
        binding.root
    ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):MovieAdapters.ListViewHolder{
